...
sed -i 's/DB-URI/${db-uri}/g' /tmp/_revolut-challenge/app/app.py; sed -i 's/USER/${db-user}/g' /tmp/_revolut-challenge/app/app.py; sed -i 's/PASSWORD/${db-password}/g' /tmp/_revolut-challenge/app/app.y
